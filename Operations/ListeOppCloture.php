    ...
    <div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   <hr>
		...
		<div class="span7">
			<h1 style="color: white;">Liste des opportunités payées et clôturées</h1>
		</div>
		<div class="span1"></div>
		<div class="span4">
	     	<h2 style="color: yellow;">Total commission  : <?php echo strrev(wordwrap(strrev((int)$com), 3, ' ', true));?></h2>
	     </div>
	   </div>	
      <hr>
	  </div>
			...
			<div class="box-content">
			  ...
			  <tbody>
		    	...
		    	<tr>
		    		...
		    		<td>
					<a class="btn btn-info" href="AnnulerPaiOpp.php?id=<?php echo $value['ID_OPP'];?>">Annuler</a>
		    		</td>		    		
		    	</tr>
		        <?php } ?>
			  </tbody>
