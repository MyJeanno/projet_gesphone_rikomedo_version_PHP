...
if (isset($_POST['num'])) {
	...
	$com->setNumeroCommande($num);
	$com->setDateReception($dater);
	$com->setMontantCommande($montant);		
	$com->Ajouter();
}
    ...
    <div class="jumbotron" style="background-color: #191970"> 	
	  <div class="container">
	   <hr>
		...
		<div class="span2"></div>
		<div class="span7">
			<h1 style="color: white;">Liste des commandes effectuées</h1>
		</div>
		<div class="span3 btn-group pull-right">
          <a href="#"><button class="btn-setting btn btn-success">Nouvelle commande <i class="icon-plus icon-white"></i></button></a>
        </div>
	   </div>	
      <hr>
	  </div>
			...
			<div class="box-content">
			  ...
			  <tbody>
		    	...
		    	<tr>
		    		...
		    		<td>
					 <a class="btn btn-info" href="EditerCommande.php?id=<?php echo $value['ID_COM'];?>"><i class="halflings-icon white edit"></i></a>
		    		</td>
		    	</tr>
		        <?php } ?>
			  </tbody>
...
<div class="modal hide fade" id="myModal">
	...
	<form class="form-horizontal" method="POST" action="ListeCommande.php">
		<div class="control-group info">
			<label class="control-label">Numéro commande</label>
			<div class="controls">
			  <input type="text" required="true" name="num">
			</div>
		</div>
		<div class="control-group info">
			<label class="control-label">Date reception</label>
			<div class="controls">
			  <input type="date" required="true" name="dr">
			</div>
		</div>
		<div class="control-group info">
			<label class="control-label">Montant commande</label>
			<div class="controls">
