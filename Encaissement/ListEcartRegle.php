...
if(isset($_GET['idEc'])){
	$id = $_GET['idEc'];
	$ec->updateAnnulerEcart($id);
    header('location:ListEcartRegle.php');
}
    ...
    <div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   <hr>
		...
		<div class="span4"></div>
		<div class="span6">
			<h1 style="color: white;">Liste des écarts reglés</h1>
		</div>
		<div class="span2">
        </div>
	   </div>	
			...
			<div class="box-content">
			  ...
			  <tbody>
		    	...
		    	<tr>
		    		...
		    		<td>
						<a class="btn btn-info" href="ListEcartRegle.php?idEc=<?php echo $value['ID_ECART'];?>">Annuler</a>
		    		</td>	
		    	</tr>
		        <?php } ?>
			  </tbody>
