...
<body> 
  ...
  <div class="jumbotron" style="background-color: #00FFFF">
	  <div class="container">
	   <hr>
	    <div class="row-fluid sortable">
		<div class="span2"></div>
		<div class="span8">
			<h2>Vente en détail (Liste des produits de la commande N° : <?php echo $numCom;?> )</h2>
		</div>
		<div class="span2">
			<div class="form-group">
          	<a href="PayerSommeBis.php"><button class="btn btn-success" name="ok">Payement <i class="icon-shopping-cart icon-white"></i></button></a>           
          </div> 
		</div>
	   </div>	
      <hr>
   	...
   	<div class="row-fluid sortable">		
		<div class="box span12">
			<div class="box-header" style="background-color: #778899;" data-original-title>
				<h2 style="color: white;"><i class="halflings-icon user"></i><span class="break"></span>Vente en détail</h2>
				<div class="box-icon">
			...
			<div class="box-content">
			  ...
			  <tbody>
				<?php 
		          $list=$appro->ListerApproCommande2($id);
		          foreach ($list as $value){?> 
		    	<tr>
		    		<td> <?php echo $value['CODE_PROD'];?></td>
		    		<td> <?php echo $value['LIBELLE_PROD'];?></td>
		    		<td> <?php echo $value['PRIX_DETAIL'];?></td>	
		    		<td> <?php echo $value['STOCK_DETAIL'];?></td>
		    		<td> 
					 <a class="btn btn-success" href="FormVenteDetail.php?id=<?php echo $value['CODE_PROD'];?>& num=<?php echo $id;?>"><i class="halflings-icon white zoom-in"></i></a>
		    		</td>
		    	</tr>
		        <?php } ?>
			  </tbody>
