...
if(isset($_POST['send'])){
	...
	$client = $_POST['client'];
	$vente = $_POST['vente'];
	header('location:VendreProduitBis.php?numero='.$id.'&client='.$client.'&vente='.$vente);
}
	 ...
	 <div class="row-fluid sortable">
		...
		<div class="box span8">
			...
			<div class="box-content">
				<form class="form-horizontal" method="POST" action="ChoixCommandeBis.php" style="background-color: #B0E0E6">
				  <fieldset>
				    ...
				    <div class="control-group info">
					  <label class="control-label">Changer de commande</label>
					    <div class="controls">
					    <select type="text" name="comR"  required="true" id="selectError1" data-rel="chosen">
						 <option value="<?php echo $numero;?>"><?php echo $numCom.' '.$dateR;?></option>
						 <?php 
				    ...
				    <div class="form-actions">
					  <button type="submit" name="send" class="btn btn-primary">Continuer</button>
					</div>
					</fieldset>
					</form>   
					</div>
