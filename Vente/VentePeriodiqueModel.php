...
if(isset($_POST['affichage'])){
    $d1=$_POST['d1'];
    $d2=$_POST['d2']; 
    $somme = $vte->PrixPeriodeVenteM($d1,$d2);
 }

 if(isset($_POST['rapport'])){
    $d1=$_POST['d1'];
    $d2=$_POST['d2']; 
    header('location:RapportVentePeriodiqueModele.php?d='.$d1."".$d2);
 }
  ...
  <?php include('../Layout/Layout.php');?>
    <div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   ...
	   <form class="form-horizontal" method="POST" action="VentePeriodiqueModel.php">	
	     <div class="span3">
   	...
   	<div class="row-fluid sortable">		
		<div class="box span12">
			<div class="box-header" style="background-color: #778899;" data-original-title>
				<h2 style="color: white;"><i class="halflings-icon user"></i><span class="break"></span>Ventes périodiques par modèle</h2>
				<div class="box-icon">
			...
			<div class="box-content">
			  ...
			  <thead>
				  <tr style="background-color: cadetblue;">
					  ...
					  <th>Montant total par modèle</th>
				  </tr>
			  </thead>   
			  <tbody>
				<?php 
		          $list=$vte->VentePeriodiqueM1($d1,$d2);
		          foreach ($list as $value){?> 
		    	<tr>		    		
		    	    <td> <?php echo $value['LIBELLE_PROD'];?></td>
		    		<td> <?php echo $value['SOMMEQTE'];?></td>
