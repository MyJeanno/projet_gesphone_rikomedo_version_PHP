   ...
   <div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   <hr>
		...
		<div class="span2"></div>
		<div class="span8">
			<h1 style="color: white;">Liste des approvisionnements journalières en détail</h1>
		</div>
		<div class="span2">
          <div class="form-group">
            <a href="RapportApproJourDet.php">
   	...
   	<div class="row-fluid sortable">		
		<div class="box span12">
			<div class="box-header" style="background-color: #778899;" data-original-title>
				<h2><i class="halflings-icon user"></i><span class="break"></span>Table des approvisionnements</h2>
				<div class="box-icon">
			...
			<div class="box-content">
			  ...
			  <tbody>
		    	...
		    	<tr>
		    		...
		    		<td>
					 <a class="btn btn-info" href="EditerApproBis.php?id=<?php echo $value['ID_APPRO'];?>"><i class="halflings-icon white edit"></i></a>
					 <a class="btn btn-danger" href="DeleteApproBis.php?id=<?php echo $value['ID_APPRO'];?>"><i class="halflings-icon white trash"></i></a>
		    		</td>
		    	</tr>
		        <?php } ?>
			  </tbody>
