...
<table style="margin-top:25mm;">
  <tr>
    <td style="width:100%"><h4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<u>SITUATION ACTUELLE DU STOCK DE PRODUITS</u></h4></td>
  </tr>
</table>
...
<table style="margin-top:2mm;" border="1">
        <thead>
            <tr>
                <th style="width:40%"><strong>Désignation</strong></th>
                <th style="width:20%"><strong>Prix en détail</strong></th>
                <th style="width:20%"><strong>Quantité stock</strong></th>
                <th style="width:20%"><strong>Stock détail</strong></th>
            </tr>
        </thead>
        <tbody>
        <?php 
