...
if(isset($_POST['suppr'])){
    ...
    $idp=$tr->showIdProduit($code);
    $destination=$tr->showTypeTransfert($code);
    if($destination=='Gros'){
    	$tr->delete($code);
        $prod->updateStockProduitDeleteTransfert($qte,$idp);
        header('location:ListeTransfert.php');
    }else{
    	$tr->delete($code);
        $prod->updateStockProduitDeleteTransfert2($qte,$idp);
        header('location:ListeTransfert.php');
    }
	...
	<div class="jumbotron" style="background-color: #191970"> 	
	  <div class="container">
	   <hr>
		...
		<div class="span4"></div>
		<div class="span8">
			<h1 style="color: white;">Supprimer un transfert de produit</h1>
		</div>
	   </div>	
      <hr>
	  </div>
	 ...
	 <div class="row-fluid sortable">
		...
		<div class="box span8">
			<div class="box-header" style="background-color: #778899;" data-original-title>
				<h2><i class="halflings-icon edit"></i><span class="break"></span>Suppression transfert</h2>
				<div class="box-icon">
			...
			<div class="box-content">
				<form class="form-horizontal" method="POST" action="DeleteTransfert.php">
						  <fieldset>
						  ...
						  <h2 style="color:red; ">Etes-vous sûr de vouloir supprimer ce transfert?</h2>
						  <table>
							  	<tr>
							  		<td><b>Id : </b></td>
