...
if(isset($_POST['valider'])){
    $enc->updateVersementConfirmer($_SESSION['id']);
    header('location:MesEncaissementVerser.php');
  }
    ...
    <div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   <hr>
		...
		<div class="span1"></div>
		<div class="span7">
			<h1 style="color: white;">Liste de mes encaissements versés</h1>
		</div>
		<form method="POST" action="MesEncaissementVerser.php">
		<div class="span2">
   	...
   	<div class="row-fluid sortable">		
		<div class="box span12">
			...
			<div class="box-content">
			  ...
			  <tbody>
				<?php 
		          $list=$enc->ListerEncaissementVerser($_SESSION['id']);
