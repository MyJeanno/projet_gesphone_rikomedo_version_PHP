	...
	<div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   <hr>
		...
		<div class="span4"></div>
		<div class="span6">
			<h1 style="color: white;">Liste des années</h1>
		</div>
		<div class="span2 btn-group pull-right">
          <a href="#"><button class="btn-setting btn btn-success">Créer une nouvelle année  <i class="icon-plus icon-white"></i></button></a>
        </div>
	   </div>	
      <hr>
	  </div>
   	...
   	<div class="row-fluid sortable">		
		<div class="box span12">
			<div class="box-header" style="background-color: #778899;" data-original-title>
				<h2><i class="halflings-icon user"></i><span class="break"></span>Année</h2>
				<div class="box-icon">
...
<div class="modal-body" style="background-color: #B0E0E6">
	<form class="form-horizontal" method="POST" action="CreerAnnee.php">
		
		<div class="control-group info">
			<label class="control-label">Libellé année</label>
			<div class="controls">
			  <input type="text" required="true" name="annee">
			</div>
		</div>	
