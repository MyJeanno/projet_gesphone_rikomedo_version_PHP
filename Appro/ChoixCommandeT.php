...
if(isset($_POST['send'])){
	$id = $_POST['numero'];
	$code = $_POST['code'];
	header('location:FormAppro.php?id='.$id."&prod=".$code);
}
	 ...
	 <div class="row-fluid sortable">
		...
		<div class="box span8">
			...
			<div class="box-content">
				<form class="form-horizontal" method="POST" action="ChoixCommandeT.php" style="background-color: #B0E0E6">
				  <fieldset>
				    <div class="control-group info">
						<label class="control-label"></label>
						<div class="controls">
						  <input type="hidden" name="code" required="true" value="<?php echo $code;?>">
