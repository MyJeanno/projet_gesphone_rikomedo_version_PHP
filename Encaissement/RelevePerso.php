    ...
    <div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   <hr>
		...
		<div class="span1"></div>
		<div class="span9">
			<h1 style="color: white;"> Relevé périodique de Mr : <?php echo $nom." ".$prenom;?></h1>
		</div>
		<div class="span2">
          <div class="form-group">
            <a href="RapportPerso.php?id=<?php echo $param; ?> ">
   	...
   	<div class="row-fluid sortable">		
		<div class="box span12">
			<div class="box-header" style="background-color: #778899;" data-original-title>
				<h2 style="color: white;"><i class="halflings-icon user"></i><span class="break"></span>Relevé des ventes</h2>
				<div class="box-icon">
			...
			<div class="box-content">
			  ...
			  <tbody>
		    	...
		    	<tr>
		    		...
		    		<td> <?php echo strrev(wordwrap(strrev($value['QTE_VENTE']), 3, ' ', true));?></td>
		    		...
		    		<td> <?php echo strrev(wordwrap(strrev($value['SOLDE_VENTE']), 3, ' ', true));?></td>
		    	</tr>
		        <?php } ?>
			  </tbody>
			  </table>            
