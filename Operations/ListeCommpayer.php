    ...
    <div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   <hr>
		...
		<div class="span6">
			<h1 style="color: white;">Liste des commissions payées</h1>
		</div>
		<div class="span1"></div>
		<div class="span5">
			  ...
			  <tbody>
		    	...
		    	<tr>
		    		...
		    		<?php if($_SESSION['niveau']=="Admin"){ ?> 
					 <a class="btn btn-info" href="AnnulerPaiement.php?id=<?php echo $value['ID_PAIE'];?>">Annuler</a>
					 <?php } ?>
		    		</td>
		    	</tr>
		        <?php } ?>
