    ...
    <div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   <hr>
		...
		<div class="span2"></div>
		<div class="span8">
			<h1 style="color: white;">Liste des transferts de produits d'un stock à l'autre</h1>
		</div>
		<div class="span2"></div>
	   </div>	
      <hr>
   	...
   	<div class="row-fluid sortable">		
		<div class="box span12">
			<div class="box-header" style="background-color: #778899;" data-original-title>
				<h2 style="color:white;"><i class="halflings-icon user"></i><span class="break"></span>Table des transferts</h2>
				<div class="box-icon">
			...
			<div class="box-content">
			  ...
			  <tbody>
		    	...
		    	<tr>
		    		<td><?php echo $value['CODE_TRANSF'];?></td>
		    	    <td><?php echo $value['LIBELLE_PROD'];?></td>
		    	    <td><?php echo $value['QTE_TRANSF'];?></td>
		    		<td><?php echo $value['DATE_TRANSF'];?></td>
		    		<td><?php echo $value['DESTINATION'];?></td>
		    		<td>
		    		<?php if($_SESSION['niveau']=="Admin"){ ?> 
					 <a class="btn btn-info" href="EditerTransfert.php?id=<?php echo $value['CODE_TRANSF'];?>"><i class="halflings-icon white edit"></i></a>
					 <a class="btn btn-danger" href="DeleteTransfert.php?id=<?php echo $value['CODE_TRANSF'];?>"><i class="halflings-icon white trash"></i></a>
					 <?php } ?>
		    		</td>
		    	</tr>
		        <?php } ?>
