...
if(isset($_POST['affichage'])){
    $d1=$_POST['d1'];
    $d2=$_POST['d2']; 
    $somme = $vte->PrixDetailPeriodeVente($d1,$d2);
 }

 if(isset($_POST['rapport'])){
    $d1=$_POST['d1'];
    $d2=$_POST['d2']; 
    header('location:RapportVentePeriodiqueDet.php?d='.$d1."".$d2);
 }
  ...
  <?php include('../Layout/Layout.php');?>
    <div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   ...
	   <form class="form-horizontal" method="POST" action="VentePeriodiqueDetail.php">	
	     <div class="span3">
	   ...
	   <?php } ?>
         <div class="span1">
          <div class="form-group">
            <button class="btn btn-success" name="affichage">Afficher <i class="icon-eye-open icon-white"></i></button>
          </div> 
        </div>
        <?php if($_SESSION['niveau']=="Admin"){ ?>
        <div class="span1">
   	...
   	<div class="row-fluid sortable">		
		<div class="box span12">
			<div class="box-header" style="background-color: #778899;" data-original-title>
				<h2 style="color: white;"><i class="halflings-icon user"></i><span class="break"></span>Ventes en détail périodiques</h2>
				<div class="box-icon">
			...
			<div class="box-content">
			  ...
			  <tbody>
				<?php 
		          $list=$vte->VenteDetailPeriodique($d1,$d2);
