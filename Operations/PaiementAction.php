  ...
  <div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   <hr>
		...
		<div class="span3"></div>
		<div class="span7">
			<h1 style="color: white;">Page de calcul et paiement des actions</h1>
		</div>
			...
			<div class="box-content">
			  ...
			  <tbody>
		    	...
		    	<tr>
		    		...
		    		<td>
					 <a class="btn btn-info" href="FormPaiement.php?id=<?php echo $value['ID_ACTION'];?>"><i class="halflings-icon white eye-open"></i></a>		 
		    		</td>
		    	</tr>
		        <?php } ?>
			  </tbody>
