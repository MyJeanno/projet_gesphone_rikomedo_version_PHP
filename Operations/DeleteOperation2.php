...
if(isset($_POST['code'])){
	...
	$mont=$_POST['montant'];
    $opera->delete($code);
    $opera->updateDepotAction($mont,$action);
	...
	<div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   <hr>
		...
		<div class="span3"></div>
		<div class="span7">
			<h1 style="color: white;">Suppression d'un retrait d'action</h1>
		</div>
		<div class="span2">
        </div>
	   </div>	
	 ...
	 <div class="row-fluid sortable">
		...
		<div class="box span8">
			<div class="box-header" style="background-color: #778899;" data-original-title>
				<h2><i class="halflings-icon edit"></i><span class="break"></span>Suppression retrait</h2>
				<div class="box-icon">
			...
			<div class="box-content">
				<form class="form-horizontal" method="POST" action="DeleteOperation2.php">
						  <fieldset>
						  ...
						  <h2 style="color:red; ">Etes-vous sûr de vouloir supprimer ce dépôt?</h2>
						  <table>
							  	<tr>
							  		<td><b>Id : </b></td>
						    ...
						    <div class="control-group info">
							  <div class="controls">
								<input type="hidden" class="span6" name="send" value=" <?php echo $act;?>">
							  </div>
							</div>
							<div class="control-group info">
							  <div class="controls">
								<input type="hidden" class="span6" name="montant" value=" <?php echo $mont;?>">
							  </div>
							</div>	        
					  <div class="form-actions">
						  <button type="submit" name="suppr" class="btn btn-primary">Supprimer</button>
						  <a class="btn btn-info" href="ListeOperation2.php">Retour à la liste</a>
					  </div>
				  </fieldset>
				</form>   
			</div>
