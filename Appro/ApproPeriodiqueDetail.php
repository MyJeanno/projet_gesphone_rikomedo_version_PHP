...
if(isset($_POST['affichage'])){
 ...
 if(isset($_POST['rapport'])){
    $d1=$_POST['d1'];
    $d2=$_POST['d2']; 
    header('location:RapportApproPeriodeDet.php?d='.$d1."".$d2);
 }
  ...
  <?php include('../Layout/Layout.php');?>
    <div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   ...
	   <form class="form-horizontal" method="POST" action="ApproPeriodiqueDetail.php">	
	     <div class="span4">
		 ...
		 <div class="span4">
	      ...
	      <div class="span2">
	      	<div class="form-group">
	          <button class="btn btn-info" name="rapport">Imprimer  <i class="icon-print icon-white"></i></button>
	         </div> 
	       </div>
	 </form>
	   </div>	
   	...
   	<div class="row-fluid sortable">		
		<div class="box span12">
			<div class="box-header" style="background-color: #778899;" data-original-title>
				<h2 style="color: white;"><i class="halflings-icon user"></i><span class="break"></span>Approvisionnements périodiques detail</h2>
				<div class="box-icon">
			...
			<div class="box-content">
			  ...
			  <tbody>
				<?php 
		          $list=$appro->QteApproPeriodiqueDet($d1,$d2);
