...
<table style="margin-top:15mm;">
  <tr>
    <td style="background-color:#C0C0C0;width:100%"><h4 style="color:white;">CLASSEMENT DES GROSSISTES SUR LA PERIODE DU <?php echo $debut;?> au <?php echo $fin;?></h4></td>
  </tr>
</table>
<table style="margin-top:5mm;" class="mabordure">
        ...
        <tbody>
        <?php 
         $list=$vte->ClassementVenteCliGros(substr($_GET['d'], 0,10),substr($_GET['d'], -10));
          foreach ($list as $v) {?>
            <tr>
