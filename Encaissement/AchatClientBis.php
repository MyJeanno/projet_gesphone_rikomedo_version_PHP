...
$nom=$vte->showLasTNomClient($numero);
$prenom=$vte->showLasTPrenomClient($numero);
    ...
    <div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   <hr>
		...
		<div class="span2"></div>
		<div class="span8">
			<h1 style="color: white;">Relevé d'achat personnel de Mr. <?php echo $nom.' '.$prenom;?></h1>
		</div>
   	...
   	<div class="row-fluid sortable">		
		<div class="box span12">
			...
			<div class="box-content">
			  ...
			  <tbody>
				<?php 
		          $list=$cli->ListerDateAchat2($numero);
		          foreach ($list as $value){?> 
	            <tr>
		    	    <td><?php echo $value['NUM_ID_VTE'];?></td>
		    		<td><a href="DetailAchatClientBis.php?d=<?php echo $value['DATE_VENTE'].''.$value['NUM_ID_VTE'];?>"> <?php echo $value['DATE_VENTE'];?></a></td>  		
		    	</tr>
		        <?php } ?>
			  </tbody>
			  </table>            
