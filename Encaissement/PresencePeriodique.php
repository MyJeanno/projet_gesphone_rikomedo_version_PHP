  ...
  <?php include('../Layout/Layout.php');?>
    <div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   ...
	   <form class="form-horizontal" method="POST" action="PresencePeriodique.php">	
	     <div class="span3">
	      ...
	      <div class="span3">
	          <div class="form-group has-success">
	            <label class="span3" style="color: white;">Date fin : </label>
	                <div class="span9">
	      ...
	      <div class="span4">
	       <div class="form-group info">
			  <label class="span3"  style="color: white;">Employé</label>
			    <div class="span9">
			    <select type="text" name="user"  required="true" id="selectError1" data-rel="chosen">
				 <option></option>
				 <?php 
   	...
   	<div class="row-fluid sortable">		
		<div class="box span12">
			<div class="box-header" style="background-color: #778899;" data-original-title>
				<h2 style="color: white;"><i class="halflings-icon user"></i><span class="break"></span>Présence périodique</h2>
				<div class="box-icon">
			...
			<div class="box-content">
			  ...
			  <tbody>
				<?php 
		          $list=$pres->showPresencePeriodique($d1,$d2,$id);
		          foreach ($list as $value){?> 
		    	<tr>
		    	    <td><?php echo $value['ID_PRESENCE'];?></td>
		    	    <td><?php echo $value['NOM_USER'];?></td>
		    	    <td><?php echo $value['PRENOM_USER'];?></td>
		    		<td> <?php echo $value['DATE_PRESENCE'];?></td>
		    		<td> <?php echo $value['HEURE_ARRIVEE'];?></td>
		    		<td> <?php echo $value['HEURE_DEPART'];?></td>
		    	</tr>
		        <?php } ?>
			  </tbody>
			  </table>            
