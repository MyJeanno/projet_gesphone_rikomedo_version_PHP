  ...
  <div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   <hr>
		...
		<div class="span2"></div>
		<div class="span10">
			<h1 style="color: white;">Liste des produits en dessous du seuil d'approvisionnement</h1>
		</div>
	   </div>	
      <hr>
	  </div>
