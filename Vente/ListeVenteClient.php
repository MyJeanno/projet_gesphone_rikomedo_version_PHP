    ...
    <div class="jumbotron" style="background-color: #87CEEB">
	  <div class="container">
	   <hr>
		...
		<div class="span4"></div>
		<div class="span8">
			<h1>Historique des ventes du jour</h1>
		</div>
	   </div>	
      <hr>
	  </div>
			...
			<div class="box-content">
			  ...
			  <tbody>
		    	...
		    	<tr>
		    		...
		    		<td> <?php echo $value['TYPE_VENTE'];?></td>
		    		<td> <?php echo $value['QTE_VENTE'];?></td>
		    		<td> <?php echo $value['PRIX_PROD'];?></td>
		    		<td> <?php echo round($value['TOTAL_VENTE']);?></td>	    		
		    		<td> <?php echo $value['MONT_PAYE'];?></td>
		    		<td> <?php echo ($value['TOTAL_VENTE'])-($value['MONT_PAYE']);?></td>
		    		<td> 
					 <a class="btn btn-info" href="EditerVente.php?id=<?php echo $value['ID_VENTE'];?>"><i class="halflings-icon white edit"></i></a>
					 <a class="btn btn-danger" href="DeleteVente.php?id=<?php echo $value['ID_VENTE'];?>"><i class="halflings-icon white trash"></i></a>
		    		</td>
		    	</tr>
		        <?php } ?>
			  </tbody>
