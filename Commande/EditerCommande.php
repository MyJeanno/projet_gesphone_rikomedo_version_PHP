...
if(isset($_GET['id'])){
	...
	$i=$row['ID_COM'];
	$num=$row['NUM_COM'];
	$d=$row['DATE_RECEPTION'];
	$mont=$row['MONTANT_COM'];
}
...
if(isset($_POST['code'])){
	...
	$com->setIdCommande($c);
	$com->setNumeroCommande($numero);
	$com->setDateReception($datere);
	$com->setMontantCommande($montant);  
    $test = $com->updateCommande();
	...
	<div class="jumbotron" style="background-color: #191970"> 	
	  <div class="container">
	   <hr>
		...
		<div class="span3"></div>
		<div class="span9">
			<h1 style="color: white;">Modifier une commande</h1>
		</div>
	   </div>	
      <hr>
	  </div>
	 ...
	 <div class="row-fluid sortable">
		...
		<div class="box span8">
			<div class="box-header" style="background-color: #778899;" data-original-title>
				<h2><i class="halflings-icon edit"></i><span class="break"></span>Formulaire commande</h2>
				<div class="box-icon">
			...
			<div class="box-content">
				<form class="form-horizontal" method="POST" action="EditerCommande.php" style="background-color: #B0E0E6">
				  <fieldset>
					...
					<div class="control-group info">
					   <label class="control-label">Numéro commande</label>
						<div class="controls">
						  <input type="text" required="true" name="numero" value="<?php echo $num; ?>" >
						</div>
				    </div>
				    <div class="control-group info">
					   <label class="control-label">Date reception</label>
						<div class="controls">
						  <input type="date" required="true" name="datere" value="<?php echo $d; ?>" >
						</div>
				    </div>
				    <div class="control-group info">
