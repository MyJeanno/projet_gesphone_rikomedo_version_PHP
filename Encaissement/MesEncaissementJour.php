...
$TotJour=$enc->totalEncaisseEmployeJourNV($_SESSION['id']);
    ...
    <div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   <hr>
		...
		<div class="span1"></div>
		<div class="span7">
			<h1 style="color: white;">Mes encaissements de la journée</h1>
		</div>
		<div class="span4">
   	...
   	<div class="row-fluid sortable">		
		<div class="box span12">
			...
			<div class="box-content">
			  ...
			  <tbody>
				<?php 
		          $list=$enc->ListerMesEncaissementJour($_SESSION['id']);
