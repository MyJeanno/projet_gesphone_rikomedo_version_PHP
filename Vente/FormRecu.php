...
if(isset($_POST['send'])){
	...
	if($niveau=='Admin'){
	    ...
	    header('location:RecuEncourClient.php');	
	         ...
	         header('location:RecuEncourClientDet.php');
		}		
	}else{
		if($type=='En gros'){
	 ...
	 <div class="row-fluid sortable">
		...
		<div class="box span8">
			...
			<div class="box-content">
				<form class="form-horizontal" method="POST" action="FormRecu.php" style="background-color: #B0E0E6">
				  <fieldset>
				     ...
				     <div class="control-group info">
					  <label class="control-label">Type de vente</label>
					    <div class="controls">
					    <select type="text" name="type"  required="true" id="selectError1" data-rel="chosen">
					    <option></option>	
