	   ...
	   <hr>
		...
		<div class="span8">
			...
			<div class="span2 btn-group pull-right">
          	<a href="RecuVenteBis.php?client=<?php echo $numCli."/".$NumVte;?>"><button type="submit" class="btn btn-success" name="ok">Imprimer <i class="icon-print icon-white"></i></button></a>           
        </div>
	   </div>	
      <hr>
	  </div>
		...
		<div class="box span12">
			...
			<div class="box-content">
			  ...
			  <tbody>
				...
				$total=0;
				$total2=0; 
		          $list=$vte->ListerDetailAchatClient($numCli,$NumVte);
                ...
                <tr>
	               ...
	               <td style="background-color: yellow;"><strong><?php echo strrev(wordwrap(strrev($solde), 3, ' ', true)); ?></strong></td>
                </tr>
			  </tbody>
			  </table>            
			</div>
