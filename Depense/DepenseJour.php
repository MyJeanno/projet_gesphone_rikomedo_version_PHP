	...
	<div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   <hr>
		...
		<div class="span2"></div>
		<div class="span6">
			<h1 style="color: white;">Liste des dépenses du jour</h1>
		</div>
		<div class="span4">
			<h1 style="color:yellow; ">Total : <?php echo strrev(wordwrap(strrev($TotJour), 3, ' ', true));?></h1>
		</div>
	   </div>	
      <hr>
	  </div>
