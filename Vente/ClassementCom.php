...
if(isset($_POST['affichage'])){
 ...
 if(isset($_POST['rapport'])){
    $d1=$_POST['d1'];
    $d2=$_POST['d2']; 
    header('location:RapportClassementCom.php?d='.$d1."".$d2);
 }
  ...
  <?php include('../Layout/Layout.php');?>
    <div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   ...
	   <form class="form-horizontal" method="POST" action="ClassementCom.php">	
	     <div class="span3">
   	...
   	<div class="row-fluid sortable">		
		<div class="box span12">
			<div class="box-header" style="background-color: #778899;" data-original-title>
				<h2 style="color: white;"><i class="halflings-icon user"></i><span class="break"></span>Classement des commerciaux</h2>
				<div class="box-icon">
			...
			<div class="box-content">
			  ...
			  <tbody>
				<?php 
		          $list=$vte->ClassementVenteClient($d1,$d2);
