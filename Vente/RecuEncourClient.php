    ...
    <div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   <hr>
		...
		<div class="span3"></div>
		<div class="span7">
			<h1 style="color: white;">Liste des reçus de vente en gros</h1>
		</div>
      ...
      <hr>
   	...
   	<div class="row-fluid sortable">		
		<div class="box span12">
			...
			<div class="box-content">
			  ...
			  <tbody>
				<?php 
		          $list=$vte->ListerRecuVente();
		          foreach ($list as $value){?> 
	            <tr>
		    	    <td><?php echo $value['NUM_ID'];?></td>
		    	    <td><?php echo $value['PRENOM_USER'];?></td>
		    	    <td><?php echo $value['NUM_CLI'];?></td>
		    	    <td><?php echo $value['NOM_CLI'];?></td>
		    	    <td><?php echo $value['PRENOM_CLI'];?></td>
		    		<td><a href="RecuClientSelect.php?d=<?php echo $value['NUM_CLI']."/".$value['NUM_ID'];?>"> <?php echo $value['DATE_VENTE'];?></a></td>  		
	   ...
	   <div class="row-fluid">
	   	<div class="span3"></div>
	   	 <div class="span6">
			<h1 style="color: white; background-color: #191970; text-align: center;">Liste des reçus de vente en détail</h1>
		</div>
		<div class="span3"></div>
	   </div>
		...
		<div class="box span12">
			...
			<div class="box-content">
			  ...
			  <tbody>
				<?php 
		          $list=$vte->ListerRecuVenteDet();
		          foreach ($list as $value){?> 
	            <tr>
		    	    <td><?php echo $value['NUM_ID_DET'];?></td>
		    	    <td><?php echo $value['CLIENT_DETAIL'];?></td>
		    		<td><a href="RecuClientSelectDet.php?d=<?php echo $value['NUM_ID_DET'];?>"> <?php echo $value['DATE_VENTE'];?></a></td>  		
		    	    <td><?php echo $value['HEURE_VENTE'];?></td>
		    	</tr>
		        <?php } ?>
			  </tbody>
