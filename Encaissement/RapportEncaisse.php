...
if(!(isset($_SESSION['niveau']))){
  ...
  $total=$enc->PrixPeriodeEncaisse(substr($_GET['d'], 0,10),substr($_GET['d'], -10));
...
<table style="margin-top:15mm;">
  <tr>
    <td style="width:100%"><h4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<u>RAPPORT DES ENCAISSEMENTS DU <?php echo $debut;?> au <?php echo $fin;?></u></h4></td>
  </tr>
</table>
...
<table style="margin-top:5mm;" class="mabordure">
        <thead>
            <tr>
                ...
                <th style="width:30%">Montant encaissé</th>
                <th style="width:20%">Date</th>
            </tr>
        </thead>
        <tbody>
        <?php 
         $list=$enc->EncaissePeriodique(substr($_GET['d'], 0,10),substr($_GET['d'], -10));
          foreach ($list as $v) {?>
            <tr>
