...
$numCli=substr($_GET['d'], 0,7);
$NumVte=substr($_GET['d'], 8);
    ...
    <div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   <hr>
		...
		<div class="span2"></div>
		<div class="span8">
			<h1 style="color: white;">Reçu de vente de Mr <?php echo $nom.' '.$prenom;?> </h1>
		</div>
			<div class="span2 btn-group pull-right">
          	<a href="RecuVenteBis2.php?client=<?php echo $numCli."/".$NumVte;?>"><button type="submit" class="btn btn-success" name="ok">Imprimer <i class="icon-print icon-white"></i></button></a>           
        </div>
	   </div>	
      <hr>
	  </div>
		...
		<div class="box span12">
			...
			<div class="box-content">
			  ...
			  <tbody>
				...
				$total=0;
				$total2=0; 
		          $list=$vte->ListerDetailAchatClient2($numCli,$NumVte);
                ...
                <tr>
	               <td colspan="3" style="background-color: #00FFFF;"><strong>Montant payé</strong></td>
	               <td style="background-color: yellow;"><strong><?php echo strrev(wordwrap(strrev($total2), 3, ' ', true)); ?></strong></td>
                </tr>
                <tr>
	               <td colspan="3" style="background-color: #00FFFF;"><strong>Reste à payer</strong></td>
