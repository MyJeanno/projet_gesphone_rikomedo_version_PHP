...
if(isset($_POST['affichage'])){
    $d1=$_POST['d1'];
    $d2=$_POST['d2']; 
    $somme = $dep->TotalDepensePeriode($d1,$d2);
 }

 if(isset($_POST['rapport'])){
    $d1=$_POST['d1'];
    $d2=$_POST['d2']; 
    header('location:RapportDepense.php?d='.$d1."".$d2);
 }
  ...
  <?php include('../Layout/Layout.php');?>
    <div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   ...
	   <form class="form-horizontal" method="POST" action="DepensePeriodique.php">	
	     <div class="span3">
	     ...
	     <div class="span4">
	      	<div class="form-group">
	      		...
	      		<div style="color: yellow;" class="span9">
	                <input type="text" readonly="true" class="form-control" value="<?php echo strrev(wordwrap(strrev($somme), 3, ' ', true));?>">
	            </div>
	         </div> 
	       </div>
         <div class="span1">
   	...
   	<div class="row-fluid sortable">		
		<div class="box span12">
			<div class="box-header" style="background-color: #778899;" data-original-title>
				<h2 style="color: white;"><i class="halflings-icon user"></i><span class="break"></span>Dépenses périodiques</h2>
				<div class="box-icon">
			...
			<div class="box-content">
			  ...
			  <tbody>
				<?php 
		          $list=$dep->DepensePeriodique($d1,$d2);
