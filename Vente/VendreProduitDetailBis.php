	   ...
	   <hr>
		...
		<div class="span2">
			<div class="form-group">
          	<a href="PayerSommeBis.php"><button class="btn btn-success" name="ok">Payement <i class="icon-print icon-white"></i></button></a>           
          </div> 
		</div>
	   </div>	
      <hr>
			...
			<div class="box-content">
			  ...
			  <tbody>
		    	...
		    	<tr>
		    		...
		    		<td> 
					 <a class="btn btn-success" href="FormVenteDetailBis.php?id=<?php echo $value['CODE_PROD'];?>&num=<?php echo $id;?>"><i class="halflings-icon white zoom-in"></i></a>
		    		</td>
		    	</tr>
		        <?php } ?>
			  </tbody>
