	 ...
	 <div class="row-fluid sortable">
		...
		<div class="box span8">
			<div class="box-header" style="background-color: #778899;" data-original-title>
				<h2><i class="halflings-icon edit"></i><span class="break"></span>Suppression dépense</h2>
				<div class="box-icon">
			...
			<div class="box-content">
				<form class="form-horizontal" method="POST" action="DeleteDepense.php">
						  <fieldset>
						  ...
						  <h2 style="color:red; ">Etes-vous sûr de vouloir supprimer cette dépense?</h2>
						  <table>
							  	<tr>
							  		<td><b>Id : </b></td>
