...
if(isset($_POST['code'])){
	...
	$tes=$ac->updateActionnaire();
    header('location:ListeActionnaire.php');
  }
?>
	...
	<div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   <hr>
		...
		<div class="span3"></div>
		<div class="span7">
			<h1 style="color: white;">Mise à jour des actionnaires</h1>
		</div>
		<div class="span2">
        </div>
	   </div>	
	 ...
	 <div class="row-fluid sortable">
		...
		<div class="box span8">
			<div class="box-header" style="background-color: #778899;" data-original-title>
				<h2><i class="halflings-icon edit"></i><span class="break"></span>Mise à jour action</h2>
				<div class="box-icon">
			...
			<div class="box-content">
				<form class="form-horizontal" method="POST" action="EditerAction.php" style="background-color: #B0E0E6">
				  <fieldset>
				    ...
				    <div class="control-group info">
					   <label class="control-label">Contact</label>
						<div class="controls">
						  <input type="number" required="true" name="cont" value="<?php echo $contact; ?>" >
						</div>
				    </div>
					<div class="control-group info">
						<label class="control-label">Taux</label>
						<div class="controls">
						  <input type="number" required="true" name="taux" value="<?php echo $taux; ?>">
						</div>
					</div>
				    <div class="form-actions">
					  <button type="submit" name="send" class="btn btn-primary">Modifier</button>
					  <a class="btn btn-info" href="ListeActionnaire.php">Retour à la liste</a>
					</div>
					</fieldset>
				</form>   
			</div>
