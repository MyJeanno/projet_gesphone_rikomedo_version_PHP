...
$vte = new vente();
$total=$vte->showTotalVteDetailJour();
    ...
    <div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   <hr>
		...
		<div class="span1"></div>
		<div class="span7">
			<h1 style="color: white;">Historique des ventes en détail de la journée</h1>
		</div>
   	...
   	<div class="row-fluid sortable">		
		<div class="box span12">
			<div class="box-header" style="background-color: #778899;" data-original-title>
				<h2 style="color: white;"><i class="halflings-icon user"></i><span class="break"></span>Liste vente détail journalière</h2>
				<div class="box-icon">
			...
			<div class="box-content">
			  ...
			  <tbody>
				<?php 
		          $list=$vte->ListerVenteJourDetail();
		    	...
		    	<tr>
		    		...
		    		<td> <?php echo $value['IMEI_TELEPHONE'];?></td>
		    		<td> <?php echo $value['ETAT_TELEPHONE'];?></td>
		    		<td> <?php echo $value['COULEUR_TEL'];?></td>
		    		...
		    		<td>
		    		<?php if($_SESSION['niveau']=="Admin"){ ?>	
					 <a class="btn btn-info" href="EditerVenteBis.php?id=<?php echo $value['ID_VENTE'];?>"><i class="halflings-icon white edit"></i></a>
					 <a class="btn btn-danger" href="DeleteVenteDetail.php?id=<?php echo $value['ID_VENTE'];?>"><i class="halflings-icon white trash"></i></a>
					 <?php } ?>
		    		</td>
		    	</tr>
		        <?php } ?>
