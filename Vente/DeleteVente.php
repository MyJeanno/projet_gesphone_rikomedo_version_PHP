...
if(isset($_POST['suppr'])){
	...
	$totVte=$vte->showTotalVteProduit($NumVte);
	$montP=$vte->showMntantVteProduit($NumVte);	
	$numC=$vte->showNumClientVteProduit($code);
	$reste=$totVte-$montP;
	
	$message="L'utilisateur a supprimé une vente";
    $vte->deleteAll($NumVte,$numC);
    $vte->updateStockProdDelVte($qtebdd,$idProd);
    $vte->updateSoldeClientDelVte($reste,$numC);
	 ...
	 <div class="row-fluid sortable">
		...
		<div class="box span8">
			...
			<div class="box-content">
				<form class="form-horizontal" method="POST" action="DeleteVente.php">
						  <fieldset>
