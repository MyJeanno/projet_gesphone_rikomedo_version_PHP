    ...
    <div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   <hr>
		...
		<div class="span3"></div>
		<div class="span9">
			<h1 style="color: white;">Annuler une vente non validée</h1>
		</div>		
	   </div>	
      <hr>
	  </div>
   	...
   	<div class="row-fluid sortable">		
		<div class="box span12">
			...
			<div class="box-content">
			  ...
			  <tbody>
				<?php 
		          $list=$vte->ListerRollback($_SESSION['id']);
		    	...
		    	<tr>
		    		...
		    		<td> <?php echo strrev(wordwrap(strrev((int)$value['PRIX_GROS']), 3, ' ', true));?></td>
		    		<td> <?php echo strrev(wordwrap(strrev((int)$value['PRIX_TOTAL']), 3, ' ', true));?></td>	    		
		    		<td> <?php echo $value['MONT_PAYE'];?></td>
		    		<td>
					 <a class="btn btn-info" href="RequeteDel.php?id=<?php echo $value['ID_VENTE'];?>">Annuler vente</a>
		    		</td>
		    	</tr>
		        <?php } ?>
			  </tbody>
