...
$prod = new produit();
$total=$prod->PrixTotalStockProduit();
  ...
  <div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   <hr>
		...
		<div class="span2"></div>
		<div class="span6">
			<h1 style="color: white;">Liste des différents produits en stock</h1>
		</div>
		<div class="span4">
			<h1 style="color: yellow;">TOTAL : <?php echo strrev(wordwrap(strrev($total), 3, ' ', true));?></h1>
		</div>
	   </div>	
      <hr>
	  </div>
