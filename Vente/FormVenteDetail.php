...
if(isset($_POST['code'])){
	...
	$NumVte=$vte->showNumVteDetEncour()+1;
    ...
    $vte->setEtatVte("Now");
    $vte->setIMEI($im);
    $vte->setCiviliteClient($civil);
    $vte->setClientDetail($nom);
    $vte->setConfirmationVente("NON VERSE");
    $vte->Ajouter();
    $vte->updateStockProduitVteDet($quantite,$code);
    $vte->updateClientVteDetail($NumCli,$civil,$nom,$NumVte);
    ...
    <br>
	 ...
	 <div class="row-fluid sortable">
		...
		<div class="box span8">
			...
			<form class="form-horizontal" method="POST" action="FormVenteDetail.php" style="background-color: #B0E0E6">
				<div class="control-group info">
				  ...
				  <fieldset>
				    <legend>Informations sur le produit : <em style="color: red">Prix de vente = <?php echo strrev(wordwrap(strrev((int)$prixDetail), 3, ' ', true)); ?></em> - Commande N° : <em><?php echo $numCom; ?></em></legend>
				    <div class="row-fluid sortable">
	 	            <div class="span6">
				    <div class="control-group info">
			      ...
			      <div class="span6">
				    ...
				    <label class="control-label">Civilité</label>
				       <div class="controls">
				        <select id="selectError1" required="true" name="sexe" data-rel="chosen">
						    <option></option>
			      ...
			      <div class="span6">
			        <div class="control-group info">
					    <label class="control-label">Nom de l'acheteur</label>
					       <div class="controls">
				    ...
				    <div class="form-actions">
					  ...
					  <a class="btn btn-info" href="VendreProduitDetail.php">Retour à la liste</a>
					</div>
					</fieldset>
					</form>   
					</div>
