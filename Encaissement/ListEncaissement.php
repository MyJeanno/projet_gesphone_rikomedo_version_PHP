    ...
    <div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   <hr>
		...
		<div class="span3"></div>
		<div class="span4">
			<h1 style="color: white;"> Encaissement du jour</h1>
		</div>
		<div class="span3">
		...
		<div class="span2">
          <div class="form-group">
            <a href="RapportEncaisseJour.php">
			...
			<div class="box-content">
			  ...
			  <thead>
				  <tr style="background-color: cadetblue;">
					  ...
					  <th>Caissier</th>
					  <th>Etat</th>
					  <th>Modifier/Supprimer/Imprimer</th>
				  </tr>
			  </thead>   
			  <tbody>
				<?php 
		    	...
		    	<tr>
		    		...
		    		<?php if($_SESSION['niveau']=="Admin"){ ?> 
					 <a class="btn btn-info" href="EditerEncaisse.php?id=<?php echo $value['ID_ENC'];?>"><i class="halflings-icon white edit"></i></a>
					 <a class="btn btn-danger" href="DeleteEncaisse.php?id=<?php echo $value['ID_ENC'];?>"><i class="halflings-icon white trash"></i></a>
					 <?php } ?>
					 <a class="btn btn-success" href="ImpressionEncaisse.php?id=<?php echo $value['NUM_CLI']."/".$value['ID_ENC'];?>"><i class="halflings-icon white print"></i></a>
		    		</td>
		    	</tr>
		        <?php } ?>
			  </tbody>
