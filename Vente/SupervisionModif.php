	...
	<div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   <hr>
		...
		<div class="span2"></div>
		<div class="span8">
			<h1 style="color: white;">Suivi des modifications des approvisionnements</h1>
		</div>
		<div class="span2">
		</div>
	   </div>	
   	...
   	<div class="row-fluid sortable">		
		<div class="box span12">
			...
			<table class="table table-striped table-condensed table-bordered bootstrap-datatable datatable">
			  ...
			  <tbody>
				<?php 
		          $list=$sess->ListerUserControle2();
		          foreach ($list as $value){?> 
		    	<tr>
		    		<td> <?php echo $value['PRENOM_USER'];?></td>
		    		<td> <?php echo $value['DATE_SUPPR'];?></td>
		    		<td> <?php echo $value['PROD_MODIFIE'];?></td>
		    		<td> <?php echo strrev(wordwrap(strrev((int)$value['PRIX_INITIAL']), 3, ' ', true));?></td>
		    		<td> <?php echo $value['LIB_PROD'];?></td>
		    		<td> <?php echo strrev(wordwrap(strrev((int)$value['PRIX_MODIFIE']), 3, ' ', true));?></td>
		    		<td> <?php echo $value['MESSAGE'];?></td>
		    		<td> <?php echo strrev(wordwrap(strrev((int)($value['PRIX_MODIFIE']-$value['PRIX_INITIAL'])), 3, ' ', true)) ;?></td>
