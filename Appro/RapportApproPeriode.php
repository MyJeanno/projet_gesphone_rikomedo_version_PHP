...
<table style="margin-top:15mm;">
  <tr>
    <td style="width:100%"><h4>&nbsp;&nbsp;<u>RAPPORT DES APPROVISIONNEMENTS EN GROS DU <?php echo $debut;?> au <?php echo $fin;?></u></h4></td>
  </tr>
</table>
...
<table style="margin-top:2mm;" class="mabordure">
        ...
        <?php
        $total=0;  
         $list=$appro->QteApproPeriodique(substr($_GET['d'], 0,10),substr($_GET['d'], -10));
          foreach ($list as $v) {
