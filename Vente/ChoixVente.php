...
if(isset($_POST['send'])){
	...
	$type = $_POST['type'];
	if($type=="En gros"){
		header('location:ModifierVente2.php?id='.$id);
	}else{
	  header('location:ModifierVenteD.php?id='.$id);	
	}
	...
	<div class="jumbotron" style="background-color: #191970"> 	
	  <div class="container">
	   <hr>
		...
		<div class="span4"></div>
		<div class="span6">
			<h1 style="color: white;">Recherche des produits d'une vente</h1>
		</div>
		<div class="span2">
		</div>
	   </div>	
	 ...
	 <div class="row-fluid sortable">
		...
		<div class="box span8">
			...
			<div class="box-content">
				<form class="form-horizontal" method="POST" action="ChoixVente.php" style="background-color: #B0E0E6">
				  <fieldset>
				    ...
				    <div class="form-actions">
					  <button type="submit" name="send" class="btn btn-primary">Afficher la vente</button>
					</div>
					</fieldset>
					</form>   
					</div>
