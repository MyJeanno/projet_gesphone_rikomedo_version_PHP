   ...
   <div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   <hr>
		...
		<div class="span3"></div>
		<div class="span9">
			<h1 style="color: white;">Sélectionner un produit à muter</h1>
		</div>
	   </div>	
      <hr>
	  </div>
   	...
   	<div class="row-fluid sortable">		
		<div class="box span12">
			...
			<div class="box-content">
			  ...
			  <tbody>
				<?php 
		          $list=$appro->ListerApproCommandeT($id);
		    	...
		    	<tr>
		    		...
		    		<td> 
					 <a class="btn btn-info" href="FormTransfert.php?id=<?php echo $value['CODE_PROD'];?>&numc=<?php echo $id; ?>"><i class="halflings-icon white zoom-in"></i></a>
		    		</td>
		    	</tr>
		        <?php } ?>
			  </tbody>
