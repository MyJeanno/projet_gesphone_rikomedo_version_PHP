...
//$total=$vte->showTotalVteGrosJourUser($_SESSION['id']);

if(isset($_POST['valider'])){
    $vte->updateVersementConfirmer($_SESSION['id']);
    header('location:MontantVenteVerser.php');
  }
    ...
    <div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   <hr>
		...
		<div class="span1"></div>
		<div class="span7">
			<h1 style="color: white;">Confirmation des montants versés</h1>
		</div>
		<form method="POST" action="MontantVenteVerser.php">
		<div class="span2">
          <div class="form-group">
            <button class="btn btn-success" name="valider">Confirmer <i class="icon-ok icon-white"></i></button>
          </div> 
        </div>
        </form>  
	   </div>	
   	...
   	<div class="row-fluid sortable">		
		<div class="box span12">
			<div class="box-header" style="background-color: #778899;" data-original-title>
				<h2 style="color: white;"><i class="halflings-icon user"></i><span class="break"></span>Confirmation des versements des ventes</h2>
				<div class="box-icon">
			...
			<div class="box-content">
			  ...
			  <tbody>
				<?php 
		          $list=$vte->ListerVenteJourUser($_SESSION['id']);
