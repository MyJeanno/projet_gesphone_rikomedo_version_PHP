...
if(isset($_POST['send'])){
	$user = $_POST['id'];
	header('location:ListerMessage.php?sender='.$user);
}
	 ...
	 <div class="row-fluid sortable">
		...
		<div class="box span8">
			...
			<div class="box-content">
				<form class="form-horizontal" method="POST" action="ChoixUser.php" style="background-color: #B0E0E6">
				  <fieldset>
				    ...
				    <div class="control-group info">
					  <label class="control-label">Utilisateurs</label>
					    <div class="controls">
					    <select type="text" name="id"  required="true" id="selectError1" data-rel="chosen">
						 <option></option>
						 <?php 
				    ...
				    <div class="form-actions">
					  <button type="submit" name="send" class="btn btn-primary">Envoyer message</button>
					</div>
					</fieldset>
					</form>   
					</div>
