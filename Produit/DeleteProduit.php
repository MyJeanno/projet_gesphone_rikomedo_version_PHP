...
if(isset($_POST['suppr'])){
	...
	$message="L'utilisateur a supprimé un téléphone";
    $prod->delete($code);
	...
	<div class="jumbotron" style="background-color: #191970"> 	
	  <div class="container">
	   <hr>
		...
		<div class="span4"></div>
		<div class="span8">
			<h1 style="color: white;">Supprimer un téléphone</h1>
		</div>
	   </div>	
      <hr>
	  </div>
	 ...
	 <div class="row-fluid sortable">
		...
		<div class="box span8">
			<div class="box-header" style="background-color: #778899;" data-original-title>
				<h2><i class="halflings-icon edit"></i><span class="break"></span>Suppression produit</h2>
				<div class="box-icon">
			...
			<div class="box-content">
				<form class="form-horizontal" method="POST" action="DeleteProduit.php">
						  <fieldset>
						  ...
						  <h2 style="color:red; ">Etes-vous sûr de vouloir supprimer ce téléphone?</h2>
						  <table>
							  	<tr>
							  		<td><b>Id : </b></td>
							  	...
							  	<tr>
							  		...
							  		<td> <i><?php echo $lib;?></i> </td>
							  	</tr>
							  	<tr>
							  		<td><b>Prix en détail : </b></td>
							  		<td><i><?php echo $detail;?></i></td>
							  	</tr>
							  	<tr>
							  		<td><b>Quantité en stock: </b></td>
							  		<td><i><?php echo $stock;?></i></td>
							  	</tr>
						  </table>	        
