    ...
    <div class="jumbotron" style="background-color: #191970"> 	
	  <div class="container">
	   <hr>
		...
		<div class="span6">
			<h1 style="color: white;">Activer/ Désactiver un client</h1>
		</div>
		<div class="span2">
        </div>
	   </div>	
			...
			<div class="box-content">
			  ...
			  <tbody>
		    	...
		    	<tr>
		    		...
		    		<td> <?php echo $value['INACTIF'];?></td>    		
		    		<td>
		    		<?php if($_SESSION['niveau']=="Admin"){ ?> 
					 <a class="btn btn-danger" href="Inactiver.php?id=<?php echo $value['NUM_CLI'];?>"><i class="halflings-icon white remove"></i></a>
					 <a class="btn btn-success" href="Activer.php?id=<?php echo $value['NUM_CLI'];?>"><i class="halflings-icon white font"></i></a>
					 <?php } ?>
		    		</td>
		    	</tr>
		        <?php } ?>
