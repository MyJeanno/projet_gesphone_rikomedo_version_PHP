...
if(isset($_POST['affichage'])){
    $d1=$_POST['d1'];
    $d2=$_POST['d2']; 
    $somme = $vte->PrixPeriodeVente($d1,$d2);
 }

 if(isset($_POST['rapport'])){
    $d1=$_POST['d1'];
    $d2=$_POST['d2']; 
    header('location:RapportClassementGros.php?d='.$d1."".$d2);
 }
  ...
  <?php include('../Layout/Layout.php');?>
    <div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   ...
	   <form class="form-horizontal" method="POST" action="ClassementGros.php">	
	     <div class="span3">
	          <div class="form-group has-success">
	            <label class="span4" style="color: white;">Date début : </label>
	                <div class="span8">
		  ...
		  <div class="span3">
	          <div class="form-group has-success">
	            <label class="span4" style="color: white;">Date de fin : </label>
	                <div class="span8">
   	...
   	<div class="row-fluid sortable">		
		<div class="box span12">
			<div class="box-header" style="background-color: #778899;" data-original-title>
				<h2 style="color: white;"><i class="halflings-icon user"></i><span class="break"></span>Classement des grossistes</h2>
				<div class="box-icon">
			...
			<div class="box-content">
			  ...
			  <tbody>
				<?php 
		          $list=$vte->ClassementVenteCliGros($d1,$d2);
		    	...
		    	<tr>
		    		...
		    		<td> <?php echo $value['total']-$value['montant'];?></td>
		    	</tr>
		        <?php } ?>
			  </tbody>
			  </table>            
