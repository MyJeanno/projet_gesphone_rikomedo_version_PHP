	...
	<div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   <hr>
		...
		<div class="span3"></div>
		<div class="span7">
			<h1 style="color: white;">Suppression d'un actionnaire</h1>
		</div>
		<div class="span2">
        </div>
	   </div>	
	 ...
	 <div class="row-fluid sortable">
		...
		<div class="box span8">
			<div class="box-header" style="background-color: #778899;" data-original-title>
				<h2><i class="halflings-icon edit"></i><span class="break"></span>Formulaires actionnaire</h2>
				<div class="box-icon">
			...
			<div class="box-content">
				<form class="form-horizontal" method="POST" action="DeleteAction.php">
						  <fieldset>
						  ...
						  <h2 style="color:red; ">Etes-vous sûr de vouloir supprimer cet actionnaire?</h2>
						  <table>
							  	<tr>
							  		<td><b>Id : </b></td>
