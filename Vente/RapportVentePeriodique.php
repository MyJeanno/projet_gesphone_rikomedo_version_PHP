...
<table style="margin-top:15mm;">
  <tr>
    <td style="background-color:#C0C0C0;width:100%"><h4 style="color:white;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RAPPORT DES VENTES DU <?php echo $debut;?> au <?php echo $fin;?></h4></td>
  </tr>
</table>
<h4 style="color:#C0C0C0;"><U>RECAPITULATIF DES VENTES</U></h4>
<table style="margin-top:2mm;" class="mabordure">
        <thead>
            <tr>
                <th style="width:35%">Total achat</th>
                <th style="width:35%">Montant payé</th>
                <th style="width:30%">Reste à payer</th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td><strong><?php echo strrev(wordwrap(strrev($total), 3, ' ', true));?></strong></td>
                <td><strong> <?php echo strrev(wordwrap(strrev($montant), 3, ' ', true));?></strong></td>
                <td><strong> <?php echo strrev(wordwrap(strrev($total-$montant), 3, ' ', true));?></strong></td>
            </tr>
        </tbody>
</table>
<h4 style="color:#C0C0C0;"><U>DETAILS DES VENTES</U></h4>
<table style="margin-top:2mm;" class="mabordure">
        <thead>
            <tr>
        ...
        <?php
        $qte=0; 
         $list=$vte->VentePeriodique(substr($_GET['d'], 0,10),substr($_GET['d'], -10));
          foreach ($list as $v) {
            $qte=$qte+$v['QTE_VENTE'];?>
            <tr>
            ...
            <?php }?>
            <tr>
              <td colspan="5"><strong>Quantité totale vendue</strong></td>
