...
if(isset($_POST['code'])){
	$code=$_POST['code'];
    $p->updateEtatPaiement2($code);
    header('location:ListeCommpayer.php');
  }
	 ...
	 <div class="row-fluid sortable">
		...
		<div class="box span8">
			...
			<div class="box-content">
				<form class="form-horizontal" method="POST" action="AnnulerPaiement.php">
						  <fieldset>
						  ...
						  <table>
							  	...
							  	<tr>
							  		<td><b>Mois : </b></td>
							  		<td> <i><?php echo $mois;?></i> </td>
							  	</tr>
							  	<tr>
							  		<td><b>Année : </b></td>
							  		<td><i><?php echo $annee;?></i></td>
							  	</tr>
							  	<tr>
							  		<td><b>Date : </b></td>
					  ...
					  <div class="form-actions">
						  ...
						  <a class="btn btn-info" href="ListeCommpayer.php">Non</a>
					  </div>
				  </fieldset>
				</form>   
			</div>
