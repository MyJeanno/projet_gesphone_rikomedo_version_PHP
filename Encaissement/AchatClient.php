    ...
    <div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   <hr>
		...
		<div class="span2"></div>
		<div class="span8">
			<h1 style="color: white;">Relevé d'achat personnel de M. <?php echo $nom.' '.$prenom;?></h1>
		</div>
   	...
   	<div class="row-fluid sortable">		
		<div class="box span12">
			...
			<div class="box-content">
			  ...
			  <tbody>
				<?php 
		          $list=$cli->ListerDateAchat($numero);
		          foreach ($list as $value){?> 
	            <tr>
		    	    <td><?php echo $value['NUM_ID'];?></td>
		    		<td><a href="DetailAchatClient.php?d=<?php echo $value['DATE_VENTE'].''.$value['NUM_ID'];?>"> <?php echo $value['DATE_VENTE'];?></a></td>  		
		    	</tr>
		        <?php } ?>
			  </tbody>
			  </table>            
