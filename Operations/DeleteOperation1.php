...
if(isset($_POST['code'])){
	...
	$mont=$_POST['montant'];
    $opera->delete($code);
    $opera->updateRetrait($mont,$action);
	...
	<div class="jumbotron" style="background-color: #191970">
	  <div class="container">
	   <hr>
		...
		<div class="span3"></div>
		<div class="span7">
			<h1 style="color: white;">Suppression d'un dépôt d'action</h1>
		</div>
		<div class="span2">
        </div>
	   </div>	
	 ...
	 <div class="row-fluid sortable">
		...
		<div class="box span8">
			<div class="box-header" style="background-color: #778899;" data-original-title>
				<h2><i class="halflings-icon edit"></i><span class="break"></span>Suppression dépôt</h2>
				<div class="box-icon">
			...
			<div class="box-content">
				<form class="form-horizontal" method="POST" action="DeleteOperation1.php">
						  <fieldset>
