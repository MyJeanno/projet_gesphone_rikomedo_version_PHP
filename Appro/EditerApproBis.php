...
if(isset($_POST['send'])){
    ...
    $message="L'utilisateur a modifié un approvisionnement";
    ...
    $app->updateApprovi();
    $prod->updateStockProduitDet($qteDiff,$idProd);
	 ...
	 <div class="row-fluid sortable">
		...
		<div class="box span8">
			...
			<div class="box-content">
				<form class="form-horizontal" method="POST" action="EditerApproBis.php" style="background-color: #B0E0E6">
				  <fieldset>
